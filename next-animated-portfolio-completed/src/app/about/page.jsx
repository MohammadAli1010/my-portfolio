      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          <div className="flex flex-col gap-12 justify-center">
            ...
            {/* BIOGRAPHY DESC */}
            <p className="text-lg">
            Hey there! I am Mohammad Ali — not the boxer, though I do throw punches at bugs in my code. I am a Full-Stack Developer who enjoys building websites that not only look good but also actually work. From pixel-perfect frontends to solid backends, I handle both sides like a good espresso — strong and balanced.
            </p>
            {/* BIOGRAPHY QUOTE */}
